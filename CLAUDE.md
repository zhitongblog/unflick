...
> `AGENTS.md` is generated from this file by `scripts/gen-agents.sh` — the two
> say the same thing and differ only in which agent they name. Edit here, then
> run the script; CI fails if they drift.
